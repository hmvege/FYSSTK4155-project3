...
\begin{figure}[h!tb]
    \centering
    \includegraphics[scale=1.0]{../fig/dnn_optimal_3d/analytical_3d_Nt10_Nlayers1_neurons1000_acttanh_optadam_dropout0_0.pdf}
...
\begin{figure}[h!tb]
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[scale=0.5]{../fig/dnn_optimal_3d/dnn_3d_Nt10_Nlayers1_neurons50_acttanh_optadam_dropout0_0.pdf}
        \caption{Neural Network.}
        \label{fig:neural-net-optimal-3d}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[scale=0.5]{../fig/dnn_optimal_3d/dnn_ana_diff_3d_Nt10_Nlayers1_neurons50_acttanh_optadam_dropout0_0.pdf}
...
\begin{figure}[h!tb]
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[scale=0.5]{../fig/fw_3d/analytical_3d_Nt5000.pdf}
        \caption{Forward-Euler.}
        \label{fig:fw-3d}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[scale=0.5]{../fig/fw_3d/fw_ana_diff_3d_Nt5000.pdf}
